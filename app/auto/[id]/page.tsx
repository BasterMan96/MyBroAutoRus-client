      ...
      <main className="auto-detail">
        <div className="auto-detail__container">
          ...
          <div className="auto-detail__content">
            <div className="auto-detail__left">
              <div className="auto-detail__gallery">
                <div className="auto-detail__main-image">
                  <Image
                    src={carData.images[0]}
                    alt={carData.title}
                    width={600}
                    height={400}
                    className="auto-detail__image"
                  />
                </div>
                <div className="auto-detail__thumbnails">
                  {carData.images.map((image, index) => (
                    <div key={index} className="auto-detail__thumbnail">
                      <Image
                        src={image}
                        alt={`${carData.title} - фото ${index + 1}`}
                        width={100}
                        height={80}
                        className="auto-detail__thumb-image"
                      />
                    </div>
                  ))}
                </div>
                ...
                <form className="auto-detail__form">
                  ...
                  <div className="auto-detail__form-agreement">
                    <label className="auto-detail__checkbox-label">
                      ...
                      />
                      <span className="auto-detail__checkmark"></span>
